...
// Thứ tự mixin quan trọng — VolumeEntity + OBVEntity phải đứng trước MACDEntity
// vì MACDEntity khai báo `on VolumeEntity, OBVEntity` (xem macd_entity.dart).
// Dart yêu cầu mixin trong `on` clause phải được apply trước.
class KEntity
    with
        CandleEntity,
        VolumeEntity,   // phải trước MACDEntity
        KDJEntity,
        RSIEntity,
        WREntity,
        CCIEntity,
