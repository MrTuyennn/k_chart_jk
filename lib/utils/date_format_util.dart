...
///
/// Example:
///     formatDate(DateTime(1989, 2), [monthNameLong]);
///     // => february
const String monthNameLong = 'MM';
...
///
/// Example:
///     formatDate(DateTime(1989, 12, 31), [weekYearPadded]);
///     // => 53
///     formatDate(DateTime(1989, 2, 21), [weekYearPadded]);
///     // => 08
const String weekYearPadded = 'WW';
...
///
/// Example:
///     formatDate(DateTime(2018, 1, 14), [weekdayNameLong]);
///     // => sunday
const String weekdayNameLong = 'DD';
...
///
/// Example:
///     formatDate(DateTime(1989, 02, 1, 15), [hour24Padded]);
///     // => 15
const String hour24Padded = 'HH';
...
///
/// Example:
///     formatDate(DateTime(1989, 02, 1, 15, 40, 10, 999), [millisecondsPadded]);
///     // => 999
///     formatDate(DateTime(1989, 02, 1, 15, 40, 10, 99), [millisecondsPadded]);
///     // => 099
///     formatDate(DateTime(1989, 02, 1, 15, 40, 10, 0), [millisecondsPadded]);
///     // => 009
const String millisecondsPadded = 'SSS';
...
///     formatDate(DateTime(1989, 02, 1, 15, 40, 10, 999), [millisecondsPadded]);
///     // => 999
///     formatDate(DateTime(1989, 02, 1, 15, 40, 10, 99), [S]);
///     // => 99
///     formatDate(DateTime(1989, 02, 1, 15, 40, 10, 9), [S]);
///     // => 9
const String S = 'S';
...
String dateFormat(DateTime date, List<String> formats) {
  ...
  for (String format in formats) {
    ...
    } else if (format == millisecondsPadded) {
